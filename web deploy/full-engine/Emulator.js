...
var Emulator = (function () {
    ...
    Emulator.prototype.keyHandler = function (evt) {
        ...
        this.DOWN_KEY = this.keymap["down"].pressed;
        this.SPACEBAR = this.keymap["spacebar"].pressed;
        if (typeof this.mappedKeyFunction != "undefined") {
     ...
     * Reset key states
     * */
    Emulator.prototype.resetKeys = function () {
        for (var kKey in this.keymap) {
            var kObj = this.keymap[kKey];
            if (kObj.pressed) {
                kObj.pressed = false;
            }
        }
...
window.addEventListener("keydown", function (e) {
    if (typeof emulator.mappedKeyFunction != "undefined") {
